...
class Contracts(Singleton):
    ...
    WBTC = RawContract(title="WBTC", address="0x8275c526d1bcec59a31d673929d3ce8d108ff5c7", abi=DefaultABIs.Token)

    WPHRS = RawContract(title="WPHRS", address="0x76aaada469d23216be5f7c596fa25f282ff9b364", abi=read_json(path=(ABIS_DIR, "weth.json")))
