...
SPOUT_ABI = [
    {"type": "function", "name": "getIdentity", "stateMutability": "view",
     "inputs": [{"internalType": "address", "name": "_wallet", "type": "address"}],
     "outputs": [{"internalType": "address", "name": "", "type": "address"}]},
    {"type": "function", "name": "getClaimIdsByTopic", "stateMutability": "view",
     "inputs": [{"internalType": "uint256", "name": "_topic", "type": "uint256"}],
     "outputs": [{"internalType": "bytes32[]", "name": "claimIds", "type": "bytes32[]"}]},
    {"type": "function", "name": "deployIdentityForWallet", "stateMutability": "nonpayable",
     "inputs": [{"internalType": "address", "name": "identityOwner", "type": "address"}],
     "outputs": [{"internalType": "address", "name": "", "type": "address"}]},
    {"type": "function", "name": "addClaim", "stateMutability": "nonpayable",
     "inputs": [
    ...
    {"type": "function", "name": "buyAsset", "stateMutability": "nonpayable",
     "inputs": [
     ...
     "outputs": []},
    {"type": "function", "name": "sellAsset", "stateMutability": "nonpayable",
     "inputs": [
         {"internalType": "uint256", "name": "adfsFeedId", "type": "uint256"},
         {"internalType": "string", "name": "ticker", "type": "string"},
         {"internalType": "address", "name": "token", "type": "address"},
...
class Spout(Base):
    ...
    async def is_identity_created(self, ) -> bool:
    ...
    async def get_claim_ids(self, identity_address: str, topic: int = 1) -> List[bytes]:
        c = await self.client.contracts.get(
            contract_address=RawContract(title="SpoutIdentity", address=identity_address, abi=SPOUT_ABI))
    ...
    async def add_claim(
        ...
        c = await self.client.contracts.get(
            contract_address=RawContract(title="SpoutIdentity", address=identity, abi=SPOUT_ABI))
        ...
        data = TxArgs(
            topic=topic,
            scheme=1,
            issuer=Web3.to_checksum_address(ISSUER_ROUTER),
            signature=sig65,
            payload=data,
            uri=''
        )
    ...
    async def _swap(self, from_token: RawContract, to_token: RawContract, amount: TokenAmount):
        ...
        logger.debug(
            f"{self.wallet} | {self.__module__} | trying to swap {amount} {from_token.title} to {to_token.title}")
    ...
    async def swap_controller(self):
        ...
        percent = random.randint(
            settings.spout_percent_min,
            settings.spout_percent_max
        ) / 100
